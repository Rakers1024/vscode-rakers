...
export default function makeFile(context: vscode.ExtensionContext) {
  const command = vscode.commands.registerCommand("vscode-rakers.makeFile", (uri: vscode.TextDocument | vscode.Uri) => {
    const settings = vscode.workspace.getConfiguration().get("vscode-rakers.makeFile") as IPluginSettings;
